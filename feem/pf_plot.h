/***************************************************************************
**                                                                        **
**  PF_GraphicView, an easy to use, modern plotting widget for Qt            **
...
**  Website/Contact: http://www.PF_GraphicView.com/                          **
**             Date: 25.06.18                                             **
**          Version: 2.0.1                                                **
****************************************************************************/
...
#define PF_GraphicView_VERSION_STR "2.0.1"
...
/*!
  The QCP Namespace contains general enums, QFlags and functions used throughout the PF_GraphicView
  library.
...
public:
  ...
  \see PF_GraphicView::savePng, PF_GraphicView::saveJpg, PF_GraphicView::saveBmp, PF_GraphicView::saveRastered
*/
...
*/
  ...
  \see PF_GraphicView::setAntialiasedElements, PF_GraphicView::setNotAntialiasedElements
*/
  ...
  \see PF_GraphicView::setPlottingHints
*/
    enum PlottingHint { phNone              = 0x000 ///< <tt>0x000</tt> No hints are set
                        ...
                        ,phImmediateRefresh = 0x002 ///< <tt>0x002</tt> causes an immediate repaint() instead of a soft update() when PF_GraphicView::replot() is called with parameter \ref PF_GraphicView::rpRefreshHint.
    ...
    /*!
  Defines the mouse interactions possible with PF_GraphicView.
...
*/
    enum Interaction { iRangeDrag         = 0x001 ///< <tt>0x001</tt> Axis ranges are draggable (see \ref QCPAxisRect::setRangeDrag, \ref QCPAxisRect::setRangeDragAxes)
                       ...
                       ,iMultiSelect      = 0x004 ///< <tt>0x004</tt> The user can select multiple objects by holding the modifier set by \ref PF_GraphicView::setMultiSelectModifier while clicking
  ...
  \see PF_GraphicView::setSelectionRectMode, PF_GraphicView::selectionRect, QCPSelectionRect
*/
...
*/
  ...
  compiler flag \c PF_GraphicView_CHECK_DATA is set.
*/
...
class QCP_LIB_DECL QCPLayer : public QObject
{
    ...
    Q_PROPERTY(PF_GraphicView* parentPlot READ parentPlot)
...
public:
  ...
  */
    ...
    QCPLayer(PF_GraphicView* parentPlot, const QString &layerName);
    virtual ~QCPLayer();

    // getters:
    PF_GraphicView *parentPlot() const { return mParentPlot; }
...
protected:
    ...
    // introduced virtual methods:
    virtual void parentPlotInitialized(PF_GraphicView *parentPlot);
    ...
    // non-property methods:
    void initializeParentPlot(PF_GraphicView *parentPlot);
...
class QCP_LIB_DECL QCPSelectionRect : public QCPLayerable
{
    Q_OBJECT
public:
    explicit QCPSelectionRect(PF_GraphicView *parentPlot);
...
class QCP_LIB_DECL QCPMarginGroup : public QObject
{
    Q_OBJECT
public:
    explicit QCPMarginGroup(PF_GraphicView *parentPlot);
...
public:
  ...
  */
    ...
    explicit QCPLayoutElement(PF_GraphicView *parentPlot=0);
...
protected:
    ...
    virtual void parentPlotInitialized(PF_GraphicView *parentPlot) Q_DECL_OVERRIDE;
...
{
public:
    explicit QCPAxisPainterPrivate(PF_GraphicView *parentPlot);
...
class QCP_LIB_DECL QCPItemAnchor
{
    Q_GADGET
public:
    QCPItemAnchor(PF_GraphicView *parentPlot, QCPAbstractItem *parentItem, const QString &name, int anchorId=-1);
...
public:
  ...
  */
    ...
    QCPItemPosition(PF_GraphicView *parentPlot, QCPAbstractItem *parentItem, const QString &name);
...
class QCP_LIB_DECL QCPAbstractItem : public QCPLayerable
{
    ...
    /// \endcond
public:
    explicit QCPAbstractItem(PF_GraphicView *parentPlot);
...
/*!
  ...
  lineData. NaN points create gaps in the line, as expected from PF_GraphicView's plottables (this is
  ...
  QPainter::drawPolyline if the configured \ref PF_GraphicView::setPlottingHints() and \a painter
  style allows.
*/
template <class DataType>
...
class QCP_LIB_DECL QCPAxisRect : public QCPLayoutElement
{
    ...
    /// \endcond
public:
    explicit QCPAxisRect(PF_GraphicView *parentPlot, bool setupDefaultAxes=true);
    virtual ~QCPAxisRect();
...
class QCP_LIB_DECL QCPTextElement : public QCPLayoutElement
{
    ...
    /// \endcond
public:
    explicit QCPTextElement(PF_GraphicView *parentPlot);
    QCPTextElement(PF_GraphicView *parentPlot, const QString &text);
    QCPTextElement(PF_GraphicView *parentPlot, const QString &text, double pointSize);
    QCPTextElement(PF_GraphicView *parentPlot, const QString &text, const QString &fontFamily, double pointSize);
    QCPTextElement(PF_GraphicView *parentPlot, const QString &text, const QFont &font);
...
class QCP_LIB_DECL QCPColorScale : public QCPLayoutElement
{
    ...
    /// \endcond
public:
    explicit QCPColorScale(PF_GraphicView *parentPlot);
...
public:
  ...
  */
    ...
    explicit QCPBarsGroup(PF_GraphicView *parentPlot);
...
class QCP_LIB_DECL QCPItemStraightLine : public QCPAbstractItem
{
    ...
    /// \endcond
public:
    explicit QCPItemStraightLine(PF_GraphicView *parentPlot);
...
class QCP_LIB_DECL QCPItemLine : public QCPAbstractItem
{
    ...
    /// \endcond
public:
    explicit QCPItemLine(PF_GraphicView *parentPlot);
    virtual ~QCPItemLine();
...
class QCP_LIB_DECL QCPItemCurve : public QCPAbstractItem
{
    ...
    /// \endcond
public:
    explicit QCPItemCurve(PF_GraphicView *parentPlot);
...
class QCP_LIB_DECL QCPItemRect : public QCPAbstractItem
{
    ...
    /// \endcond
public:
    explicit QCPItemRect(PF_GraphicView *parentPlot);
    virtual ~QCPItemRect();
...
class QCP_LIB_DECL QCPItemText : public QCPAbstractItem
{
    ...
    /// \endcond
public:
    explicit QCPItemText(PF_GraphicView *parentPlot);
    virtual ~QCPItemText();
...
class QCP_LIB_DECL QCPItemEllipse : public QCPAbstractItem
{
    ...
    /// \endcond
public:
    explicit QCPItemEllipse(PF_GraphicView *parentPlot);
...
class QCP_LIB_DECL QCPItemPixmap : public QCPAbstractItem
{
    ...
    /// \endcond
public:
    explicit QCPItemPixmap(PF_GraphicView *parentPlot);
...
public:
  ...
  */
    ...
    explicit QCPItemTracer(PF_GraphicView *parentPlot);
...
public:
  ...
  */
    ...
    explicit QCPItemBracket(PF_GraphicView *parentPlot);
