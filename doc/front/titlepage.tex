...
\draw (cp)  node [xshift=-9.5cm,yshift=12cm,scale=6.5,right] {开{\color{orange}\textit{发}}};
\draw (cp)  node [xshift=-9cm,yshift=10cm,scale=3,right] {\fantaisie 笔记};

% Auteurs au centre sous le titre
\draw (cp)  node [xshift=-8.7cm,yshift=7.73cm,scale=2,right,color={red},align=left] {十};
