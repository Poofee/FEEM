...
void AddRibbonGroupCommand::init(RibbonPage* ribbonPage, RibbonGroup* group)
{
    ...
    QDesignerFormEditorInterface* core = formWindow()->core();
    m_ribbonGroup = group;
    if (m_ribbonGroup == Q_NULL)
        m_ribbonGroup = qobject_cast<RibbonGroup *>(core->widgetFactory()->createWidget(QLatin1String("Qtitan::RibbonGroup"), m_ribbonPage));
