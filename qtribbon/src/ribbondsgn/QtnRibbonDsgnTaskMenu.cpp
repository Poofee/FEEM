...
void StyleDsgnTaskMenu::slot_removeStyle()
{
    ...
    : QObject(parent)
{
    ...
    connect(m_addGroupAction, SIGNAL(triggered()), this, SLOT(slot_addGroup()));
    connect(m_removePageAction, SIGNAL(triggered()), this, SLOT(slot_removePage()));
}
...
void DsgnRibbonPageTaskMenu::slot_addGroup()
{
    if (QDesignerFormWindowInterface* fw = QDesignerFormWindowInterface::findFormWindow(m_ribbonPage)) 
    {
        AddRibbonGroupCommand* cmd = new AddRibbonGroupCommand(fw);
        cmd->init(m_ribbonPage);
        cmd->redo();
        //    fw->commandHistory()->push(cmd);
    }
}

void DsgnRibbonPageTaskMenu::slot_removePage()
{
}
    ...
    : QObject(parent)
{
    ...
    connect(m_removeGroupAction, SIGNAL(triggered()), this, SLOT(slot_removeRibbonGroup()));
    m_removePageAction = new QAction(tr("Remove Ribbon Page"), this);
    connect(m_removePageAction, SIGNAL(triggered()), this, SLOT(slot_removeRibbonPage()));
}
...
void DsgnRibbonGroupTaskMenu::slot_removeRibbonGroup()
{
}

void DsgnRibbonGroupTaskMenu::slot_removeRibbonPage()
{
}
