...
namespace Qtitan
{
    ...
    public:
        void init(RibbonBar* ribbonBar, RibbonPage* page = Q_NULL);
    ...
    class AddRibbonGroupCommand: public FormDsgnCommand
    {
    public:
        explicit AddRibbonGroupCommand(QDesignerFormWindowInterface* formWindow);
    public:
        void init(RibbonPage* ribbonPage, RibbonGroup* group = Q_NULL);
        virtual void undo();
        virtual void redo();
    private:
