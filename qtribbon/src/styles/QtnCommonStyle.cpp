...
void CommonStyle::drawPrimitive(PrimitiveElement pe, const QStyleOption* option, QPainter* p, const QWidget* widget) const
{
    ...
    switch(pe)
    {
        ...
        case PE_IndicatorViewItemCheck:
                ret = !isNativeDialog(widget) && drawIndicatorViewItemCheck(pe, option, p, widget);
            break;
        ...
        case PE_FrameTabWidget :
            ...
            break;
        case PE_FrameWindow :
                ret = !isNativeDialog(widget) && drawFrameWindow(option, p, widget);
            break;
