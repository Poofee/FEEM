...
void PopupOffice2003DrawHelper::refreshPalette()
{
    ...
    switch (m_styleType)
    {
        ...
        case OS_SYSTEMWHITE:
            {
                m_palBackground.setColor(QPalette::Light, QColor(255, 255, 255));
                m_palBackground.setColor(QPalette::Dark, QColor(255, 255, 255));

                m_palGripper.setColor(QPalette::Light, QColor(238, 238, 238));
                m_palGripper.setColor(QPalette::Dark, QColor(238, 238, 238));

                m_palFrame.setColor(QPalette::Light, QColor(162, 162, 162));
                m_palFrame.setColor(QPalette::Dark, QColor(162, 162, 162));

                QColor color(43, 87, 154);
                m_clrButtonSelected = DrawHelpers::colorMakePale(color.rgb(), .9);
                m_clrButtonPressed = DrawHelpers::colorMakeDarker(m_clrButtonSelected.rgb(), .14);
                m_clrButtonSelectedBorder = m_clrButtonPressed;
                m_clrButtonPressedBorder = m_clrButtonPressed;
            }
            break;
        case OS_SYSTEMGRAY:
            {
                m_palBackground.setColor(QPalette::Light, QColor(241, 241, 241));
                m_palBackground.setColor(QPalette::Dark, QColor(241, 241, 241));

                m_palGripper.setColor(QPalette::Light, QColor(230, 230, 230));
                m_palGripper.setColor(QPalette::Dark, QColor(230, 238, 230));

                m_palFrame.setColor(QPalette::Light, QColor(198, 198, 198));
                m_palFrame.setColor(QPalette::Dark, QColor(198, 198, 198));
